      ...
      <Card>
        <CardHeader className="border-b border-border pb-0">
          <button
            ...
            className="w-full flex items-center justify-between py-1 text-sm font-medium text-foreground hover:opacity-80 transition-opacity"
          >
            <CardTitle>New Scrape</CardTitle>
            <svg
              className={`w-4 h-4 text-muted-foreground transition-transform ${scrapeOpen ? "rotate-180" : ""}`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
