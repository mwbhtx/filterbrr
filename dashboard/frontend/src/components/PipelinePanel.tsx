...
export default function SimulatorToolbar({
  ...
  const selectCls = "w-full rounded bg-gray-800 border border-gray-700 px-3 py-1.5 text-sm text-gray-100 disabled:opacity-50";
        ...
        <>
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                {!selectedTrackerType && (
                  <option value="">— select a tracker first —</option>
                )}
